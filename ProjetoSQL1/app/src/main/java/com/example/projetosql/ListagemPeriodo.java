...
public class ListagemPeriodo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listagem_periodo);
    ...
    public void carregarLista (){
        periodoList = bd.listarPeriodos();

        for (Periodo pe : periodoList){

            adicionarBlocoDeRegistro(pe);

        }

    }

    public void adicionarBlocoDeRegistro(final Periodo periodo){

        TableLayout tableLayout = (TableLayout) findViewById(R.id.tableLayoutPeriodoListagem);
        ...
        editarBtA.setText(String.valueOf(periodo.getCodPeriodo()));
        ...
        editarBtb.setText(periodo.getNome());
        ...
        editarBtC.setText(periodo.getDataInicio());
        ...
        editarBtD.setText(periodo.getDataFim());
